...
public class FileSender {
	...
	public FileSender(FileSenderParams fileSenderParams) throws ParseException, SchedulerException  {
		...
		scheduler.getContext().put("FileSenderParams", fileSenderParams);
		scheduler.start();
